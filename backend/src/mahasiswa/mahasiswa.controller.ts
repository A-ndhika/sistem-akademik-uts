...
export class MahasiswaController {
  ...
  findOne(@Param('nim') nim: string) {
    ...
    if (!mhs) throw new NotFoundException(`Mahasiswa dengan NIM ${nim} tidak ditemukan`);
    return mhs;
  }
  ...
  update(@Param('nim') nim: string, @Body() dto: UpdateMahasiswaDto) {
    ...
    if (!updated) throw new NotFoundException(`Mahasiswa dengan NIM ${nim} tidak ditemukan`);
    return updated;
  }
  ...
  remove(@Param('nim') nim: string) {
    ...
    if (!deleted) throw new NotFoundException(`Mahasiswa dengan NIM ${nim} tidak ditemukan`);
    return deleted;
  }
}
